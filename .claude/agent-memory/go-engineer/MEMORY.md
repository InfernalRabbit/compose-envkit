...
- [lipgloss/termenv color control](lipgloss-termenv-color-control.md) — v1.1.0/termenv v0.16.0 verified: per-renderer SetColorProfile(Ascii) forces plain (no global), WithTTY/SetColorProfile forces color, HasDarkBackground blocking-OSC gotcha; no seam violation
